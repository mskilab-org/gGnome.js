class WalkInterval extends Interval {
  ...
  get popoverContent() {
    ...
    [{label: 'Chromosome', value: this.chromosome}, {label: 'Y', value: d3.format('.2f')(this.y)}, {label: 'Start Point (chromosome)', value: d3.format(',')(this.startPoint)},
     {label: 'End Point (chromosome)', value: d3.format(',')(this.endPoint)}, {label: 'Interval Length', value: d3.format(',')(this.intervalLength)}, {label: 'Strand', value: this.strand}, {label: 'Weight', value: this.walk.cn}].forEach(function(e,j) {
