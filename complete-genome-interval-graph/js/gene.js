class Gene extends Interval {
  ...
  get popoverContent() {
    let content = '';
    [{label: 'Chromosome', value: this.chromosome}, {label: 'Type', value: this.type}, {label: 'Start Point (chromosome)', value: d3.format(',')(this.startPoint)}, {label: 'Start Point (genome)', value: d3.format(',')(this.startPlace)},
     {label: 'End Point (chromosome)', value: d3.format(',')(this.endPoint)}, {label: 'End Point (genome)', value: d3.format(',')(this.endPlace)}, {label: 'Length', value: d3.format(',')(this.intervalLength)}, {label: 'Strand', value: this.strand}].forEach(function(e,j) {
